...
class ElectricityReadingStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'electricity_meter_id' => 'required|integer|exists:electricity_meters,id',
            'meter_value_wbp' => 'required|numeric|min:0',
            'meter_value_lwbp' => 'required|numeric|min:0',
            'photo_wbp' => 'required|image|mimes:jpeg,png,jpg,gif|max:5120',
            'photo_lwbp' => 'required|image|mimes:jpeg,png,jpg,gif|max:5120',
        ];
    }
